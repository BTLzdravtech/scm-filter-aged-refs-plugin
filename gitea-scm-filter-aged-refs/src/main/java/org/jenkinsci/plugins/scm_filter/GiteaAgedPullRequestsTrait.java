...
public class GiteaAgedPullRequestsTrait extends AgedTypeRefsTrait {
    ...
    public GiteaAgedPullRequestsTrait(String retentionDays) {
        super(retentionDays);
    }
    ...
    @Extension
    @Selection
    @Symbol("giteaAgedPullRequestsTrait")
